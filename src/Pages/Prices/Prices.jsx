...
const Prices = () => {
      ...
      <div className="serviceCardsGrid">
        ...
        <h3>ლოგოსა და ბრენდის იდენტობის დიზაინი</h3>
          <ul>
            ...
            <li>სოციალური მედიის ბრენდინგი (პროფილის სურათები, ბანერები და პოსტის შაბლონები)</li>
          </ul>
          ...
          <ul>
            ...
            <li>პროდუქციის დიზაინი (ფეხსაცმელი, მაისურები, სუვენირები და სხვა)</li>
          </ul>
          ...
          <h3>ილუსტრაციები</h3>
          <ul>
            <li>ილუსტრაციები რედაქტორისთვის, ბრენდინგისთვის ან პროდუქციისთვის</li>
  ...
  <ul>
    <li>ვებსაიტების შექმნა HTML, CSS და JavaScript-ის გამოყენებით</li>
    <li>სივი/პორტფოლიოს საიტები, ლენდინგ ფეიჯები, ბლოგები და ბიზნესის ვებსაიტები</li>
    <li>რეაქტიული (Responsive) დიზაინი, რომელიც ყველა მოწყობილობაზე კარგად გამოიყურება</li>
    <li>ვებ-ანიმაციები და ინტერაქტიული ელემენტები, რაც საიტის ვიზუალურ მხარეს გაამრავალფეროვნებს</li>
    <li>ტექნოლოგიები და ხელსაწყოები (React, Angular, Next.js) რთული ვებსაიტების ან აპლიკაციების შესაქმნელად</li>
    <li>კროს-ბრაუზერული თავსებადობა, რათა საიტი ყველგან კარგად მუშაობდეს</li>
  </ul>
  
  <h3>UX/UI ინტეგრაცია</h3>
  <ul>
    <li>UX/UI დიზაინის იმპლემენტაცია და ოპტიმიზაცია, რომ საიტი იყოს მოსახერხებელი და ვიზუალურად მიმზიდველი</li>
    <li>ქსელის ოპტიმიზაცია და გვერდების ჩატვირთვის სისწრაფის გაუმჯობესება</li>
    <li>ინტერაქტიული კომპონენტების დამატება, როგორიცაა ნავიგაცია, ფორმები, ღილაკები და სხვა ელემენტები</li>
  </ul>
  
  <h3>ვებსაიტების ოპტიმიზაცია</h3>
  <ul>
    <li>SEO ოპტიმიზაცია, რათა საიტი საძიებო სისტემებში მაღალ პოზიციაზე იყოს</li>
    <li>პროგრესული ვებ აპლიკაციების (PWA) განვითარება, რომ საიტი იმუშაოს როგორც ნატურალური აპლიკაცია</li>
    <li>ვებსაიტის წვდომის გაუმჯობესება და შშმ პირებისთვის ხელმისაწვდომი დიზაინი</li>
  </ul>
  
  <h3>მუდმივი მხარდაჭერა და განახლება</h3>
  <ul>
    <li>ვებსაიტის ტექნიკური მხარდაჭერა და რეგულარული განახლებები</li>
    <li>ახალი ფუნქციების დამატება, როგორიცაა ფორუმი, გალერეა, სოციალური მედიის ინტეგრაცია და სხვა</li>
...
<div className="serviceCard BK">
  ...
  <ul>
    <li>ვებ აპლიკაციების სერვერის მხარის განვითარება, როგორიცაა რეგისტრაცია/ავტორიზაცია, მომხმარებლის პროფილები</li>
    <li>ფორუმი, ბლოგი, კომუნიკაციის სისტემები და ჩეთები</li>
    <li>გადახდის სისტემები, სადაც მომხმარებელს შეუძლია პროდუქტების ყიდვა</li>
    <li>სერვერის არქიტექტურის შექმნა და API-ების შემუშავება, რომელიც კომუნიკაციას ახდენს წინა მხარესთან</li>
    <li>მონაცემთა ბაზის დიზაინი და მართვა (SQL და NoSQL ტექნოლოგიები)</li>
    <li>უსაფრთხოების მექანიზმების იმპლემენტაცია, რათა დაცული იყოს მომხმარებლის მონაცემები</li>
  </ul>
  
  <h3>ინტეგრაცია და მასშტაბურობა</h3>
  <ul>
    <li>მონაცემთა მასშტაბირებადი სისტემების შექმნა, რათა დიდი რაოდენობის მომხმარებელი ერთდროულად ემსახუროს</li>
    <li>ქლაუდ სერვისების ინტეგრაცია (AWS, Google Cloud, Azure) საიტის სანდოობისა და სისწრაფის უზრუნველსაყოფად</li>
    <li>რეალურ დროში მონაცემების მართვა (WebSockets, ჩატები, ნოტიფიკაციები)</li>
  </ul>
  
  <h3>უსაფრთხოება და შესრულება</h3>
  <ul>
    <li>სერვერის უსაფრთხოების გაუმჯობესება, მონაცემების დაცვა და ქურდობისგან დაცვა</li>
