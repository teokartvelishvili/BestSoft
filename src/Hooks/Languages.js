export const TEXTS = {
  ge: {
    ...
    light: "დღე",
    dark: "ღამე",
    welcomeText: "მოგესალმებით BestSoft ოჯახში!",
    weTransform:
      "ჩვენ ვაქცევთ იდეებს ციფრულ რეალობად. როგორც ოთხი საუკეთესო მეგობრისგან შემდგარი მჭიდრო გუნდი, ჩვენ ვართ თქვენი ხედვის რეალიზებისთვის ჩვენი ყოვლისმომცველი სერვისების კომპლექტით.",
